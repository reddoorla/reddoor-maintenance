...
function rfEta(label) {
  return label === "lighthouse" ? "~48m" : label === "security" ? "~2m" : "";
}
  ...
  return status.perWorkflow
    .map(function (w) {
      ...
      if (!done && !isFailed) {
        ...
        var link = w.url
          ? ' · <a href="' + w.url + '" target="_blank" rel="noopener">view run ↗</a>'
          : "";
