...
> [#712](https://github.com/reddoorla/reddoor-maintenance/issues/712).
...
> remedy was wrong for two of them. The pseudocode below is left as written; it
> records the design as it stood.
