...
Date: 2026-08-17
Status: **approved and largely BUILT** — phases 0–4 complete, phase 5 in progress.
Tracking issue: **#539**

> **Read the plan for current state.**
> [`plans/2026-08-17-airtable-to-turso-migration.md`](../plans/2026-08-17-airtable-to-turso-migration.md)
> carries the live phase status. This file is the DESIGN as approved on
> 2026-08-17 and is deliberately left as a record of what was decided and why —
> it is not kept in step with the code. Two things in it are known to be
> superseded, flagged inline below: the three-table split is no longer
> provisional, and Phase 5's one-line summary was reversed by the 2026-08-25
> decisions (#612).
...
above is provisional until it does. ⚠️ **RESOLVED:** the writer map shipped as `specs/2026-08-23-websites-writer-map.md`, so the split is no longer provisional.
