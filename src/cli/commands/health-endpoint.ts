...
import { healthEndpoint } from "../../recipes/health-endpoint/index.js";
...
export type HealthEndpointCommandOptions = {
  fleet?: string;
  workdir?: string;
  cwd?: string;
};
...
export async function runHealthEndpointCommand(
  site: string | undefined,
  opts: HealthEndpointCommandOptions,
  ...
  const results = await runRecipeOverSites("health-endpoint", sites, (s) => healthEndpoint(s));
